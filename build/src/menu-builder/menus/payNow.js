    ...
    run: () =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        if (payment == 200) {
          ...
          menu.end(
            `Your request for ${policy_type.toUpperCase()} ${beneficiary.toUpperCase()}, UGX ${premium} has been received and will be processed shortly.Please enter your Airtel Money PIN when asked.`
          );
        } else {
