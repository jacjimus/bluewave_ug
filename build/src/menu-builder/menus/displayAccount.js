      ...
      __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          if (!policies || policies.length === 0) {
            throw new Error(
              "Sorry, No paid policies found, please buy a policy first or contact customer care"
            );
          }
          ...
          const { policy_id, premium, policy_type, beneficiary, sum_insured } =
            selectedPolicy;
          ...
          const claim = yield Claim.create({
            ...
            claim_description: `Admission of Claim: ${claimId} for Member ID: ${
              user.membership_id
          ...
          if (claim) {
            ...
            const message =
              policy_type.toLowerCase() === "MINI"
                ? bronzeMessage
                : goldAndSilverMessage;
            yield (0, sendSMS_1.default)(phoneNumber, message);
            menu.end(
              `Admission Claim - CLAIM ID: ${
                claim.claim_number
              },  ${policy_type.toUpperCase()} ${beneficiary.toUpperCase()} - Premium: UGX ${premium}, SUM INSURED: UGX ${sum_insured} \nProceed to the reception to verify your details\n0. Back\n00. Main Menu"`
            );
          } else {
