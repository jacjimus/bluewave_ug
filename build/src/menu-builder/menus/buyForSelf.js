...
function buyForSelf(menu, args, db) {
  ...
  const findPaidPolicyByUser = (user) =>
    __awaiter(this, void 0, void 0, function* () {
  ...
  menu.state("buyForSelf", {
    run: () =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        if (policy) {
          menu.end(
            `You already have an ${policy.policy_type.toUpperCase()} ACTIVE policy`
          );
          return;
        }
        menu.con(
  ...
  menu.state("buyForSelf.bronze", {
    run: () =>
      __awaiter(this, void 0, void 0, function* () {
        let { first_name, last_name, phone_number } = yield getUser(
          args.phoneNumber
        );
  ...
  menu.state("buyForSelf.bronze.pay", {
    run: () => {
      menu.con(
        "Pay UGX 10,000  deducted monthly." +
  ...
  menu.state("buyForSelf.bronze.pay.yearly", {
    run: () => {
      menu.con(
        "Pay UGX 120,000 deducted yearly." +
          "\nTerms&Conditions - www.airtel.com" +
          "\nEnter PIN or Membership ID to Agree and Pay" +
          "\n0.Back" +
          "\n00.Main Menu"
  ...
  menu.state("buyForSelf.bronze.confirm", {
    run: () =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const { pin, user_id, partner_id, membership_id } = yield getUser(
          args.phoneNumber
        );
        ...
        let installment_alert_date = new Date(
          date.getFullYear(),
          date.getMonth() + 1,
          date.getDate() - 3
        );
        ...
        console.log("NEW POLICY MINI SELF", newPolicy);
        ...
        const message = `PAID UGX 10,000 to AAR UGANDA for MINI Cover Cover Charge UGX 0. Bal UGX 10,000. TID: 715XXXXXXXX. Date: ${new Date().toLocaleDateString()}. `;
  ...
  menu.state("buyForSelf.silver.pay", {
    run: () => {
      menu.con(
        "Pay UGX 14,000 deducted monthly." +
          "\nTerms&Conditions - www.airtel.com" +
          "\nEnter PIN or Membership ID to Agree and Pay" +
          "\n0.Back" +
          "\n00.Main Menu"
  ...
  menu.state("buyForSelf.silver.yearly.pay", {
    run: () => {
      menu.con(
        "Pay UGX 167,000 deducted yearly." +
          "\nTerms&Conditions - www.airtel.com" +
          "\nEnter PIN or Membership ID to Agree and Pay" +
          "\n0.Back" +
          "\n00.Main Menu"
  ...
  menu.state("buyForSelf.gold.pay", {
    run: () => {
      menu.con(
        "Pay UGX 18,000  deducted monthly." +
          "\nTerms&Conditions - www.airtel.com" +
          "\nEnter PIN or Membership ID to Agree and Pay" +
          "\n0.Back" +
          "\n00.Main Menu"
  ...
  menu.state("buyForSelf.gold.yearly.pay", {
    run: () => {
      menu.con(
        "Pay UGX 208,000 deducted yearly." +
          "\nTerms&Conditions - www.airtel.com" +
          "\nEnter PIN or Membership ID to Agree and Pay" +
          "\n0.Back" +
          "\n00.Main Menu"
  ...
  menu.state("buyForSelf.gold.yearly.confirm", {
    run: () =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        let newPolicy = yield Policy.create(policy);
        console.log("NEW POLICY BIGGIE SELF", newPolicy);
        const allPolicy = yield Policy.findAll({
          where: {
            user_id: user_id,
          },
