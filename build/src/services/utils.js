...
exports.calculatePremium = exports.isInRange = exports.excelFilter = exports.formatPhoneNumber = exports.calculateProrationPercentage = exports.formatAmount = exports.parseAmount = exports.calculatePaymentOptionsKenya = exports.calculatePaymentOptions = exports.generateClaimId = exports.generatePolicyNumber = exports.generateQuotationNumber = exports.globalSearch = exports.isValidEmail = exports.getRandomInt = exports.isValidKenyanPhoneNumber = void 0;
...
function calculatePaymentOptionsKenya(policyType, paymentOption) {
...
exports.calculatePaymentOptionsKenya = calculatePaymentOptionsKenya;
...
function calculatePremium(vehiclePremiums, vehicle_category, vehicle_type, vehicle_cv, vehicle_tonnage, vehicle_number_of_passengers, is_fleet) {
    ...
    vehicle_type = (vehicle_type === null || vehicle_type === void 0 ? void 0 : vehicle_type.toUpperCase()) || "";
    ...
    if (["CAR", "JEEP", "PICKUP"].includes(vehicle_category)) {
        ...
        if ((vehicle_type === "PRIVATE" || vehicle_type === "CORPORATE") &&
            vehicleCV) {
            switch (true) {
        ...
        if (vehicle_tonnage) {
            ...
            if ((0, exports.isInRange)(tonnageNumeric, 0, 3.5)) {
                premium = vehiclePremiums['TRUCKS']['OWN_ACCOUNT_TRANSPORT']["Truck_<=3.5T"];
            }
            else if ((0, exports.isInRange)(tonnageNumeric, 3.6, 8)) {
                premium = vehiclePremiums['TRUCKS']['OWN_ACCOUNT_TRANSPORT']["Truck_3.6T-8T"];
            }
            else if ((0, exports.isInRange)(tonnageNumeric, 9, 15)) {
