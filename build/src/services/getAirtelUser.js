...
exports.getAirtelKenyaUser = exports.getUserByPhoneNumber = exports.getAirtelUser = void 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!userData) {
                ...
                yield sendSMS_1.default.sendSMS(2, user.phone_number, message);
...
function getAirtelKenyaUser(phoneNumber) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = yield (0, auth_1.default)(1);
...
exports.getAirtelKenyaUser = getAirtelKenyaUser;
