...
exports.updatePremium =
  exports.fetchMemberStatusData =
  exports.updateMember =
  exports.renewMember =
  exports.registerDependant =
  exports.registerPrincipal =
    void 0;
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      if (response.data.code == 200) {
        yield User.update(
          { is_active: true, arr_member_number: response.data.member_no },
...
function updatePremium(data, policy) {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      ...
      const main_benefit_limit =
        policy.installment_type == 2
          ? policy.sum_insured
          : policy.sum_insured / 12;
      const last_expense_limit =
        policy.installment_type == 2
          ? policy.last_expense_insured
          : policy.last_expense_insured / 12;
      const requestData = {
