...
const getPolicies = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const filter = ((_b = (_a = req.query) === null || _a === void 0 ? void 0 : _a.filter) === null || _b === void 0 ? void 0 : _b.toString().toLowerCase()) || "";
        ...
        const whereCondition = Object.assign(Object.assign({ partner_id: partner_id, policy_status: 'paid' }, dateFilters), searchFilters);
...
const findUserByPhoneNumberPolicies = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        let policy = yield Policy.findAll({
            where: Object.assign({ user_id: user_id, policy_status: 'paid', partner_id: partner_id }, dateFilters),
            limit: 100,
        });
 ...
 *         description: Invalid request
 */
function vehicleRegistration(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // Destructure the request body to extract necessary information
            const { user_id, partner_id, vehicle_category, vehicle_make, vehicle_model, vehicle_year, vehicle_vin, vehicle_license_plate, vehicle_registration_number, vehicle_insurance_expiration, vehicle_purchase_price, vehicle_mileage, } = req.body;
            // Check if required fields are present in the request
            if (!user_id || !partner_id || !vehicle_category || !vehicle_make) {
                return res.status(400).json({ message: 'Invalid request. Missing required fields.' });
            }
            // Create a new vehicle record in the database
            const registeredVehicle = yield db_1.db.vehicles.create({
                user_id,
                partner_id,
                vehicle_category,
                vehicle_make,
 ...
 *         description: Invalid request
 */
function calculatePremiumBasedOnVehicleDetails(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let { vehicle_category, vehicle_type, vehicle_cv, vehicle_tonnage, vehicle_number_of_passengers, is_fleet } = req.query;
            ...
            const premium = (0, utils_1.calculatePremium)(vehiclePremiums, vehicle_category, vehicle_type, vehicle_cv, vehicle_tonnage, vehicle_number_of_passengers, is_fleet);
            return res.status(200).json({
                code: 200,
                status: "OK",
...
/**
  ...
  *         description: Invalid request
  */
const createHealthPolicy = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let partner_id = (req.body.partner_id).toString();
        let partner = yield Partner.findOne({ where: { partner_id } });
    ...
    <p>Thank you.</p>`;
        yield (0, emailService_1.sendEmail)("admin@bluewave.insure", subject, emailHtml);
        return res.status(200).json({
            result: {
                code: 200,
                status: "OK",
...
/**
  ...
  *         description: Invalid request
  */
const submitSelfCover = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { membership_type, number_of_family_members, medical_cover_type, user_id, partner_id } = req.body;
        const user = yield User.findOne({ where: { user_id: user_id, partner_id: partner_id } });
        if (!user) {
            return res.status(404).json({
                code: 404,
