  ...
  return new Promise((resolve, reject) =>
    __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        let buildInput = {
          ...
          partner_id:
            user === null || user === void 0 ? void 0 : user.partner_id,
        };
        ...
        menu.state("buyForSelf.bronze", {
          run: () =>
            __awaiter(this, void 0, void 0, function* () {
              ...
              console.log("USER", user);
              let product = yield Policy.findOne({
                where: {
                  partner_id: 1,
                },
              });
        ...
        menu.state("buyForSelf.bronze.confirm", {
          run: () =>
            __awaiter(this, void 0, void 0, function* () {
              ...
              const { pin, id, partner_id } = yield getUser(args.phoneNumber);
              let date = new Date();
    ...
    Date: ${new Date().toLocaleDateString()}. `;
        ...
        menu.state("confirmation", {
          run: () =>
            __awaiter(this, void 0, void 0, function* () {
              const { id, phone_number, partner_id } = yield getUser(
                args.phoneNumber
              );
        ...
        menu.state("payNow", {
          run: () =>
            __awaiter(this, void 0, void 0, function* () {
              const bronzeMaternityBenefit = "KES 100,000";
              const silverMaternityBenefit = "KES 100,000";
              const goldMaternityBenefit = "KES 100,000";
              let user = yield User.findOne({
                where: {
                  phone_number: args.phoneNumber,
                },
              ...
              for (let i = 0; i < policies.length; i++) {
                ...
                if (policy.policy_type == "bronze") {
                  ...
                  benefit = silverMaternityBenefit;
                } else if (policy.policy_type == "gold") {
                  benefit = goldMaternityBenefit;
                }
                policyInfo +=
                  `${
                    i + 1
        ...
        menu.state("choosePolicyTomakeClaim", {
          run: () =>
            __awaiter(this, void 0, void 0, function* () {
              ...
              policies = policies[policy - 1];
              console.log("POLICIES: ", policies);
              let { id, premium, policy_type, beneficiary, sum_insured } =
                policies;
              ...
              if (hospitals) {
                const hospitalDetails = {
                  ...
                  "Nairobi Hospital - Nairobi": {
                    ...
                    contact:
                      "+254-20-2845000/2846000, customercare@nbihosp.org",
                  },
                  "Aga Khan University Hospital - Nairobi": {
        ...
        reject(
          "END " +
            lang_1.default[configs_1.default.default_lang].generic.fatal_error
        );
      }
    })
  );
